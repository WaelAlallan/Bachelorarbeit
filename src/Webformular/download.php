...
<head>
   ...
   <meta charset="utf-8">
   <title>IVV5 - download</title>
   <meta http-equiv="x-ua-compatible" content="IE=edge">
   <meta name="author" content="Westfälische Wilhelms-Universität Münster, IVV5/Lammers">
   ...
   <meta name="X-Imperia-Live-Info" content="225be384-6b28-a38b-7c08-d962bf4a6aa5/1125/279205">
         ...
         <div class="wrapper-complement-nav six columns">
            ...
            <nav class="nav-language-container">
               ...
               <?php if (!isset($_GET['logout'])) : ?>
                  <a href="download.php?logout='1'" style="color: black; font-size: 17px;">Abmelden</a>
               <?php endif ?>
            </nav>
         </div>
      </div>
            ...
            <article class="module extended">
               <div class="module-content">
                  ...
                  <h2 class="ueberschrift">
                     <?php if ($_GET['page'] == 'krank') {
                        echo 'Krankmeldung';
                     } elseif ($_GET['page'] == 'gesund') {
                        echo 'Gesundmeldung';
                     } elseif ($_GET['page'] == 'urlaub') {
                        echo 'Urlaubsantrag';
                     } ?>
                  </h2><br>
                  <p style=" margin-bottom: 350px;"> 
                     <?php if ($_GET['page'] == 'krank'  ||  $_GET['page'] == 'gesund') :   ?>
                        <strong> Vielen Dank! Ihre Angaben sind erfolgreich übermittelt worden.</strong> <br><br><br> Ihre Vorgesetzten haben entsprechend eine Benachrichtigung darüber erhalten, und Ihr Anliegen wird demnächst bearbeitet.
                     <?php else :   ?>
                        <strong> Vielen Dank! Ihre Angaben sind erfolgreich übermittelt worden.</strong> <br><br><br> Ihre Vorgesetzten haben entsprechend eine Benachrichtigung darüber erhalten. Hier können Sie das Formular als
                        <a href="<?php echo generated_files_dir . "/" . $_GET['link']; ?>" download>PDF herunterladen</a>
                     <?php endif   ?>
                  </p>
               </div>
            </article>
