...
<head>
   ...
   <meta charset="utf-8">
   <title>IVV5 - Gesundmeldung</title>
...
<body id="mnav" class="layout2017">
   ...
   <div class="wrapper" id="top">
         ...
         <div class="wrapper-complement-nav six columns">
            ...
            <nav class="nav-language-container">
               ...
               <?php if (!isset($_GET['logout'])) : ?>
                  <a href="gesundmeldung.php?logout='1'" style="color: black; font-size: 17px;">Abmelden</a>
               <?php endif ?>
            </nav>
         </div>
      </div>
      <div class="content row">
         <section id="inhalt" class="main four columns" role="main">
            ...
            <article class="module extended">
               <div class="module-content">
                  <form onsubmit="return validate_gm()" onchange="change()" id="gesundmeldungsformular" method="post" action="generate_gesund.php">
                     <h2 class="ueberschrift">Gesundmeldung</h2>
                     <deleteme>
                        <p>Hier können Sie sich wieder gesundmelden. Dazu tragen Sie bitte Ihre Daten ein und klicken Sie abschließend auf Absenden!</p>
                     </deleteme>
                     <p style="margin-bottom: 35px;">Ihre Angaben:</p>
                     <p>
                        <label for="name">Name, Vorname:</label>
                        <input type="text" name="name" class="medium namenfeld_gesund" id="name" value="<?php echo $daten->nachname . ', ' . $daten->vorname; ?>" disabled>
                     </p>
                     <p>
                        <label for="wiederaufnahme">Tag der Wiederaufnahme des Dienstes:</label>
                        <input type="date" name="wiederaufnahme" class="medium" id="wiederaufnahme" max="<?php echo date('Y-m-d'); ?>" readonly required> <!-- required  -->
                        <label id="alert0" class="alert">Bitte geben Sie ein gültiges Datum ein!</label>
                        <label id="alert1" class="alert">Hinweis: Bitte beachten Sie, das von Ihnen ausgewählte Datum entspricht nicht dem heutigen Datum.</label>
                     </p>
                     <div id="gesundmeldung_row">
                        <p>
                           <label id="alert2" class="alert">Bitte überprüfen Sie Ihre Angaben! Sie sind aktuell nicht krankgemeldet.</label>
                        </p>
         ...
         <script>
            var aktuellkrank = <?php echo  json_encode($daten->aktuellkrank);   ?>; // bool ob aktuell krank
         </script>
         <script src="../js/validation_gm.js"></script>
